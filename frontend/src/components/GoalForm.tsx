...
export default function GoalForm({ onSubmit, initialValues, isLoading = false }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Daily Calorie Target (kcal)</label>
        <input
          type="number"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Weight Goal (kg, optional)</label>
        <input
          type="number"
          step="0.1"
